...
INSERT INTO container (shipMmsiCode, numberId, checkDigit, isoCode, maxWeight, payload, tare, weight, maxWeightPacked, maxVolumePacked, repairRecommendation, certificate)
values('210950000', 3, 4, '20G0', 400, 200, 300, 100, 450, 350, 'necessary', 'certificate');

INSERT INTO cargoManifest(id)
values ('ID5005');

INSERT INTO cargoManifestContainer(containerNumberId, cargoManifestId, containerShipMmsiCode, xContainer, yContainer, zContainer, grossContainer)
values(3, 'ID5005', '210950000', 0, 0, 0, 53);
...
INSERT INTO cargoManifestContainer(containerNumberId, cargoManifestId, containerShipMmsiCode, xContainer, yContainer, zContainer, grossContainer)
values(3, 'ID5005', '210950001', 0, 0, 0, 53);
...
INSERT INTO cargoManifestContainer(containerNumberId, cargoManifestId, containerShipMmsiCode, xContainer, yContainer, zContainer, grossContainer)
values(3, 'ID5004', '210950001', 0, 0, 0, 53);
...
INSERT INTO cargoManifestContainer(containerNumberId, cargoManifestId, containerShipMmsiCode, xContainer, yContainer, zContainer, grossContainer)
values(2, 'ID5005', '210950001', 0, 0, 0, 53);
