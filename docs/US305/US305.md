...
## *Script Analysis*
#### 1. O Script receberá por parâmetro o “registrationCode”, isto é, o identificador do contentor e retornará uma String que conterá as informações desejadas sobre o percurso do respetivo contentor. Foram declaradas as variáveis demonstradas na figura seguinte. O Cursor será responsável por iterar os Cargo Manifests Load cujo contentor está inserido.
