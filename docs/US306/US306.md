...
#### 1. Para atender os resiquistos impostos pela US306, começamos por criar um Trigger responsável por calcular a ocupação de um Armazém sempre que um novo contentor é adicionado ou retirado de um armazém. Para isso, começamos por guardar na variável "destAux" o destino de um determinado contentor.
