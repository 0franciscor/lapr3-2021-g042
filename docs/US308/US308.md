...
## *Script Analysis*
#### Para atender os resiquistos impostos pela US308, começamos por criar um Trigger que não permite que o número de Contentores num Cargo Manifest exceda a capacidade disponível no Ship. Iterou-se os Cargo Manifest incompletos do respectivo Ship.
...
#### Como o Ship tem capacidade 1, ao tentar inserir um segundo contentor, lançar-se-á um erro uma vez q ja passa do limite.
