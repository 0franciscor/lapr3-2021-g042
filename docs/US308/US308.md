...
## *Script Analysis*
#### Para atender os resiquistos impostos pela US308, começamos por criar um Trigger que não permite que o número de Contentores num Cargo Manifest excede a capacidade disponível no Ship. Iterou-se os Cargo Manifest incompletos do respectivo Ship.
