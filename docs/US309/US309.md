...
#### Para atender os resiquistos impostos pela US309, começamos por criar um Trigger que não permite um determinado Ship ser registado se já estiver ocupado. Iterou-se os Cargo Manifest incompletos do respectivo Ship.
