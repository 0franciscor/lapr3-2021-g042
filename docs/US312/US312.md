...
#### 2. Posteriormente iremos verificar se o "ClientOwner" do contentore é igual ao "ClientOwner" recebido por paramêtro.
...
#### 1. Primeiros adcionamos dois Cargo Manifest Load para poder testar esta Us 
![image7.png](US312_md/image7.png)

#### 2. De seguida, adcionamos fases para esse dois cargo Manifests 
...
#### 4. E por fim , adcionamos os CargoManifestContainer relacionados com contentores e com os Cargo Manifest Load 
![image10.png](US312_md/image10.png)

#### 5. Como o Cargo Manifest Load de Id 2000 possui um Cargo Manifes Unload a localização do contentor será igual ao Porto em que este foi descarregado, sendo o nome do Porto de destino "nec", como podemos ver na figura abaixo o resultado é exatamente este 
