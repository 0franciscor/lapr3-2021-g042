...
public class ListSomeShipDataControllerTest {
    ...
    ListSomeShipDataController controller;

    List<BriefSummary> bstList;

    List<BriefSummary> briefSummariesA;

    List<BriefSummary> briefSummariesD;

    Company company;

    ImportShipController ctr;

    public ListSomeShipDataControllerTest(){
        company = new Company();
        ctr = new ImportShipController(company);
        System.out.println( ctr.importFile("sships.csv"));
        controller = new ListSomeShipDataController();
        bstList = new ArrayList<>();
        briefSummariesA = new ArrayList<>();
        briefSummariesD = new ArrayList<>();
